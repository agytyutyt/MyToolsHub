...
| --- | --- |
| 当前分支 | `main` |
| HEAD | **本提交**（第四轮收尾：核心包出包 + manifest 组件名同步 + 文档实测数据回写） |
...
| 远程 | `origin = https://github.com/agytyutyt/MyToolsHub.git`；`main` **已同步**（最近一次推送 `ca69141..a425917`，2026-09-14，含离线部署与核心包两轮） |
