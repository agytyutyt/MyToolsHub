# 知识库插件 Office 预览与文档下载 · 设计文档

> **原名 `插件库优化方案-设计文档.md`（2026-09-17 改名，原名与内容不符）。**
...
- [x] **5.3 `docs/design/知识库插件-设计文档.md`**：增补「阶段 7：PDF 预览 + 原件下载」记录本轮改动
  （事实源仍为本文件，此处只记落地结果）。
...
- [x] **7.7 文档同步**：本文件（阶段 7 + §13 决策）、`docs/design/知识库插件-设计文档.md`（阶段 8）、
