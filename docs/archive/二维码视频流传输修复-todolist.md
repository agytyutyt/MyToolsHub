...
> **✅ 已归档（2026-09-17）** —— 归档原因：**12 项待办全部完成（`[x]`，2026-09-06 起分三轮收口）**，
> 相机传输模式默认开启、播放加速根治、FEC 冗余维持 0.4 等结论已并入信息传输主线。
> **现行落点**：`plugins/info-transfer/README.md`「移动端 APP」节；
> 后续演进看 `docs/plan/信息传输优化TODO清单.md`。本文件**内容不再维护**。
