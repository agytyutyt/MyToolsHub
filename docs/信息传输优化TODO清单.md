...
### T11 · Office/ZIP 拆包重组（S6，`mode=rebuild`） 【状态：已完成（2026-09-16 两端代码落地；2026-09-17 真机联调通过；Office/WPS 人工验收待做）】
