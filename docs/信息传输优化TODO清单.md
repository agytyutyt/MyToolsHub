...
### T08 · 二进制直载：去双重 base64（P3 / DS §7.1） 【状态：已完成（2026-09-16，桌面端 + APP 代码落地；真机 PoC 待做）】
